...
foreign import capi "sqlite3_prepare_v2"
    c_sqlite3_prepare_v2
        :: Ptr CDatabase
        -> CString              -- ^ SQL statement, UTF-8 encoded.
...
foreign import capi unsafe "sqlite3_db_handle"
    c_sqlite3_db_handle :: Ptr CStatement -> IO (Ptr CDatabase)

-- | <https://www.sqlite.org/c3ref/step.html>
foreign import capi "sqlite3_step"
    c_sqlite3_step :: Ptr CStatement -> IO CError

-- | <https://www.sqlite.org/c3ref/step.html>
foreign import capi unsafe "sqlite3_step"
...
foreign import capi unsafe "sqlite3_reset"
...
-- /Warning:/ If the most recent 'c_sqlite3_step' call failed,
-- this will return the corresponding error code.
foreign import capi "sqlite3_finalize"
...
foreign import capi unsafe "sqlite3_clear_bindings"
    c_sqlite3_clear_bindings :: Ptr CStatement -> IO CError

-- | <https://www.sqlite.org/c3ref/sql.html>
foreign import capi unsafe "sqlite3_sql"
...
-- | <https://www.sqlite.org/c3ref/bind_blob.html>
foreign import capi unsafe "sqlite3_bind_zeroblob"
    c_sqlite3_bind_zeroblob
        :: Ptr CStatement -> CParamIndex -> CInt -> IO CError

-- | <https://www.sqlite.org/c3ref/bind_blob.html>
foreign import capi unsafe "sqlite3_bind_text"
    c_sqlite3_bind_text
        :: Ptr CStatement
        -> CParamIndex
...
foreign import capi "sqlite3_create_function_v2"
    c_sqlite3_create_function_v2
        :: Ptr CDatabase
...
foreign import capi "sqlite3_free"
...
foreign import capi unsafe "sqlite3_blob_open"
    c_sqlite3_blob_open
        :: Ptr CDatabase
